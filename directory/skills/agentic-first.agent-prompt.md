...
> Author hub: <https://agentic-first.co/directory/adopt/>
> Recipes (per host, per mode): <https://github.com/yqup/agentic-first/tree/main/directory/docs/recipes>
> Skill version: 0.1.4
>
...
that conforms to the current `agentic-first` standard.
...
- [ ] No prompt-injection patterns in `tagline`, `summary`, `bio`, `notes` fields. (See the directory's rejected-pattern list at <https://agentic-first.co/directory/security/>.)
...
>    [`docs/recipes/`](https://github.com/yqup/agentic-first/tree/main/directory/docs/recipes)
...
5. **If the user's host doesn't appear in the table**, link them to
   <https://github.com/yqup/agentic-first/blob/main/directory/docs/embed-recipes.md>
