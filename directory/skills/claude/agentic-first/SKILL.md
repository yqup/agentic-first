...
at <https://agentic-first.co/directory/standard/#company-public>. Walk it in
...
<https://agentic-first.co/directory/standard/#person-public>. Names,
...
<https://agentic-first.co/directory/standard/#company-protected> and
<https://agentic-first.co/directory/standard/#person-protected>.
...
1. **Recommended publishing:** save as `agentic-profile.json` and host at
   ...
   <https://agentic-first.co/directory/adopt/embed-recipes/> — see Step 5b
   below for the decision tree and short summary. Spec-level hosting
   notes also at <https://agentic-first.co/directory/standard/#host>.
