...
`https://agentic-first.co/directory/healthz` reading at the moment you
...
- Author-side companion skill (for the inverse workflow): <https://agentic-first.co/directory/skills/claude/agentic-first/SKILL.md>
