...
| Field                  | Type                  | Notes                                                       |
| ---------------------- | --------------------- | ----------------------------------------------------------- |
| `schema_version`       | string (semver)       | `"0.2.0"` for the current company-public schema; `"0.1.0"` remains accepted for backward-compatible company-public documents |
...
- `https://agentic-first.co/directory/schemas/company-profile-{version}.json`
- `https://agentic-first.co/directory/schemas/company-private-profile-{version}.json`
- `https://agentic-first.co/directory/schemas/personal-profile-{version}.json`
- `https://agentic-first.co/directory/schemas/personal-private-profile-{version}.json`
